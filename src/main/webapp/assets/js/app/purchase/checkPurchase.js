define(['ajaxPackage', 'timePicker', 'select', 'table', 'jqueryConfirm'],
    function (Lprapm, timePicker) {
        var checkPurchase = function () {
            ...
            /*显示下拉框*/
            $('#checkPurchase .selectAskPur').selectpicker('show');
            // 加载日期下来框
            ...
            function editTable(row) {
                if (row.purState == "采购中") {
                    ...
                    $.confirm({
                        ...
                        closeAnimation: 'rotate',
                        backgroundDismiss: true,
                        content: '不在采购中状态或已经采购完成登记,不能再次登记',
                    });
                }
            }
            ...
            function operateFormatter(value, row, index) {
                return [
                    '<a class="edit" href="javascript:void(0)" title="采购完成登记" style="margin-right:5px;">',
            ...
            function searchParams() {
                var sendParams = $("#searchCPForm").serializeArray();
